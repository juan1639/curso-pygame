...
class Game:
	...
	def instancias(self):
		...
		self.formacion = Formacion(self, formX, formY, 400, 300, 2, 8)

		for i in range(3):
			for ii in range(4):
				enemigo = Enemigo(self, ii, i, formX, formY)
				self.lista_spritesAdibujar.add(enemigo)
	...
	def draw(self):
		...
		self.formacion.dibuja(self.pantalla)
