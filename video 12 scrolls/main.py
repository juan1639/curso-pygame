...
class Game:
	...
	def instancias(self):
		...
		scroll_1 = ScrollParallax(self, 0, 150, 1, '../assets/moonpatrol1.png')
		self.arrayScrolls.append(scroll_1)

		scroll_2 = ScrollParallax(self, 0, 350, 2, '../assets/moonpatrol2.png')
		self.arrayScrolls.append(scroll_2)

		scroll_3 = ScrollParallax(self, 0, 520, 3, '../assets/moonpatrol3.png')
